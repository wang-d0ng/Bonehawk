...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("packaged-smoke", "Desktop", "Packaged smoke", "Run packaged app readiness checks and write logs/packaged_smoke.json.", "python scripts/packaged_smoke.py", ("{python}", "scripts/packaged_smoke.py"), timeout=120),
